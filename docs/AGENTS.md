...
- **2 Ledgers:** Personal (PHP) and Business (USD). Never mix them. A Business expense may be *entered*
  in pesos and is auto-converted to USD at that date's rate, keeping the original amount and rate
  (Module 5); Personal is always PHP and never converted.
